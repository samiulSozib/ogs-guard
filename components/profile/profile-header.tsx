      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex justify-center -mt-10 mb-3">
          <div className="relative">
            <div className="w-20 h-20 rounded-full bg-white p-0.5 shadow-lg">
            ...
            <div className="absolute -bottom-1 -right-1 bg-[#5F0015] rounded-full p-1.5 border-2 border-white">
        ...
        <div className="text-center mb-3">
          <h2 className="text-lg font-bold text-gray-900">{guard?.full_name}</h2>
          <div className="flex items-center justify-center gap-2 mt-1">
            <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${
              ...
              <div className={`h-1.5 w-1.5 rounded-full ${guard?.is_active ? 'bg-green-500' : 'bg-red-500'}`} />
        ...
        <div className="mt-3 pt-3 border-t border-gray-100">
          <div className="bg-gray-50 rounded-lg px-3 py-2">
            <p className="text-xs text-gray-500 text-center">Guard Code</p>
